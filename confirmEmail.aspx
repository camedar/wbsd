...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:20%;margin-left:5%;margin-right:auto">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txt_email" placeholder="something@example.com" class="form-control" type="email"  aria-describedby="emailHelp" runat="server" ReadOnly="True"></asp:TextBox>
        ...
        <asp:Button ID="lnk_resendCode" runat="server" OnClick="lnk_resendCode_Click" CausesValidation="False" class="btn btn-primary" Text="Resend Code"/>
    </div>
</asp:Content>
